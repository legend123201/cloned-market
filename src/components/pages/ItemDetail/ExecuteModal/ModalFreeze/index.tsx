...
import { DropDownOption } from '../../ItemInformation/styled';
// item actions
...
export interface IModalFreezeProps {
	isOpen: boolean;
	setIsOpen: Function;
	refetchApi: Function;
}

export default function ModalFreeze({ isOpen, setIsOpen, refetchApi }: IModalFreezeProps) {
	...
	return (
		...
		>
			<Typography variant="body2">
				Locking my metadata, my content is permanently stored in decentralized file storage
				(IPFS) and cannot be edited nor removed. All of my content is exactly how it's
			...
			{checked && (
				<>
					<DividerGradient />
					<Stepper activeStep={activeStep} orientation="vertical" sx={{ mb: 2, mt: 1 }}>
						{/* ===================================================================== STEP 1 =====================================================================*/}
						<Step>
							<StepLabel
							...
							<StepContent>
								...
								<Box sx={{ mb: 2, mt: 1 }}>
									<ButtonGradient
										...
										disabled={step1.isChecking || step1.isExecuting || !checked}
										sx={{ width: '180px' }}
									>
							...
							<StepContent>
								...
								<Box sx={{ mb: 2 }}>
									<ButtonGradient
										...
										disabled={step2.isChecking || step2.isExecuting || !checked}
										sx={{ width: '180px', mt: 1 }}
									>
