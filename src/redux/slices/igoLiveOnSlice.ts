...
export const selectListItemAuction = (state: RootState) => state.igoLiveOn.listAutionId;
export const selectPagination = (state: RootState) => state.igoLiveOn.pagination;
export const selectLoading = (state: RootState) => state.igoLiveOn.isLoading;
export const selectFilter = (state: RootState) => state.igoLiveOn.filter;
export const selectHasNextPage = (state: RootState) => state.igoLiveOn.hasNextPage;
