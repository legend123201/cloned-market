...
export const selectListItemAuction = (state: RootState) => state.igoUpcoming.listAutionId;
export const selectPagination = (state: RootState) => state.igoUpcoming.pagination;
export const selectLoading = (state: RootState) => state.igoUpcoming.isLoading;
export const selectFilter = (state: RootState) => state.igoUpcoming.filter;
export const selectHasNextPage = (state: RootState) => state.igoUpcoming.hasNextPage;
