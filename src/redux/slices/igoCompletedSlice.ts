...
export const selectListItemAuction = (state: RootState) => state.igoCompleted.listAutionId;
export const selectPagination = (state: RootState) => state.igoCompleted.pagination;
export const selectLoading = (state: RootState) => state.igoCompleted.isLoading;
export const selectFilter = (state: RootState) => state.igoCompleted.filter;
export const selectHasNextPage = (state: RootState) => state.igoCompleted.hasNextPage;
