...
export const selectListItemAuction = (state: RootState) => state.auctionUpcoming.listAutionId;
export const selectPagination = (state: RootState) => state.auctionUpcoming.pagination;
export const selectLoading = (state: RootState) => state.auctionUpcoming.isLoading;
export const selectFilter = (state: RootState) => state.auctionUpcoming.filter;
export const selectHasNextPage = (state: RootState) => state.auctionUpcoming.hasNextPage;
