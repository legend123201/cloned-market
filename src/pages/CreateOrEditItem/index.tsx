...
function CreateOrEditItem() {
	...
	const onSubmit = async (data: IFormAddOrEditItemInputs) => {
		...
		// console.log('create item itemMedia', itemMedia);
		...
		try {
			...
			const res: Response<NFT> = await nftsApi.getDetailNftItemById(itemIdTemp);
					...
					>
						<Stepper activeStep={activeStep} orientation="vertical" sx={{ mb: 2 }}>
							...
							<Step>
								...
								<StepContent>
									<Typography>
										We are uploading your item to our store.
									</Typography>
